        ...
        <footer className="footer footer-horizontal footer-center text-primary-content p-10">
          <aside>
            ...
            <p className="font-bold">
              Ashir Par FoodBall Club.
              <br />
              Building Football Excellence Since 2021
            </p>
            ...
            <div className="flex items-center gap-3 justify-center mt-3">
              ...
              />
              <p className="font-medium">Developed by Hasan Kabir Robin ❤️</p>
            </div>
          </aside>
          <nav>
            <div className="grid grid-flow-col gap-4">
              ...
              <a 
              href="https://www.facebook.com/profile.php?id=100076283802380" target="_blank" rel="noopener noreferrer"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
